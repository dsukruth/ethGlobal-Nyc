...
import { invariant as invariant$1, encodeMessageFromSignable, config as config$1, resolve, pipe, interaction, createSignableVoucher, send, getTransactionStatus, decode, block, getEventsAtBlockHeightRange, subscribeEvents, getAccount, arg } from '@onflow/sdk';
...
function normalize(_ref) {
  ...
  invariant$1(template.f_version === "1.0.0", "generateTemplateId({ template }) -- template object must be version 1.0.0");
...
async function normalizeInteractionTemplate(template) {
