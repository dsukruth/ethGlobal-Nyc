 ...
 */ class InvalidRetryOnFailCallError extends getNetworkProviderBuilderRegistry.BaseError {
...
const mapVerifiedCredentialChainToChain = (verifiedCredentialChain)=>{
    ...
    getNetworkProviderBuilderRegistry.assertDefined(chain, `Unknown chain: ${verifiedCredentialChain}`);
    return chain;
};

const convertVerifiedCredentialToWalletAccount = (verified)=>{
    getNetworkProviderBuilderRegistry.assertDefined(verified.address, 'Missing address in verified credential');
    getNetworkProviderBuilderRegistry.assertDefined(verified.chain, 'Missing chain in verified credential');
    getNetworkProviderBuilderRegistry.assertDefined(verified.walletName, 'Missing wallet name in verified credential');
 ...
 */ const getWalletAccounts = (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
 ...
 */ const isSignedIn = (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>Boolean(client.user || getWalletAccounts(client).length > 0);
    ...
    return {
       ...
       */ localStorage.removeItem(getPrefixedKey(storageKeySchema.key));
        ...
        setItem: async (storageKeySchema, value)=>{
            ...
            if (!parsed.success) {
                throw new getNetworkProviderBuilderRegistry.InvalidStorageSet({
 ...
 */ const fetchProjectSettings = async (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    ...
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
...
const logout = async (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
    try {
    ...
    getNetworkProviderBuilderRegistry.emitEvent({
        event: 'logout'
    }, client);
 ...
 */ const initializeAuth = (client)=>{
    ...
    const onChangeExpiration = getNetworkProviderBuilderRegistry.subscribeWithSelector(core.state, (state)=>state.sessionExpiresAt);
...
const raiseStateEvents = (client)=>{
    ...
    core.state.subscribe((value, previous)=>{
        ...
        eventEntries.forEach(([key, event])=>{
            ...
            if (getNetworkProviderBuilderRegistry.isEqualShallow(value[key], previous[key])) return;
            getNetworkProviderBuilderRegistry.emitEvent({
                args: {
                    [key]: value[key]
                },
...
const SDK_API_CORE_VERSION = getNetworkProviderBuilderRegistry.dependencies['@dynamic-labs/sdk-api-core'];
...
class ClientAlreadyInitializedError extends getNetworkProviderBuilderRegistry.BaseError {
    constructor(){
        super({
            cause: null,
 ...
 */ const initializeClient = async (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
 ...
 */ const createAsyncTrack = ()=>{
   ...
   */ const checkIfAllSettled = ()=>{
    ...
    const track = ({ name, promise })=>{
        if (!isTrackEnabled) {
            throw new getNetworkProviderBuilderRegistry.CannotTrackError();
        }
...
class UnavailableInServerSideError extends getNetworkProviderBuilderRegistry.BaseError {
...
class InvalidStorageValue extends getNetworkProviderBuilderRegistry.BaseError {
 ...
 */ const createCore = (config)=>{
    ...
    return {
        ...
        state,
        storage,
        version: getNetworkProviderBuilderRegistry.version
    };
};
 ...
 */ const createDynamicClient = (config)=>{
    ...
    getNetworkProviderBuilderRegistry.setDefaultClient(client);
    return client;
};

class InvalidRedirectStorageStateError extends getNetworkProviderBuilderRegistry.BaseError {
    constructor(){
        super({
            cause: null,
...
class MissingRedirectStorageStateError extends getNetworkProviderBuilderRegistry.BaseError {
    constructor(){
        super({
            cause: null,
...
class MissingSocialUrlParamError extends getNetworkProviderBuilderRegistry.BaseError {
    constructor(param){
        super({
            cause: null,
...
class NoAddressFoundError extends getNetworkProviderBuilderRegistry.BaseError {
    constructor(){
        super({
            cause: null,
...
class NoPasskeyCredentialsFoundError extends getNetworkProviderBuilderRegistry.BaseError {
    constructor(){
        super({
            cause: null,
...
class NoWebAuthNSupportError extends getNetworkProviderBuilderRegistry.BaseError {
    constructor(){
        super({
            cause: null,
...
class UserNotAuthenticatedError extends getNetworkProviderBuilderRegistry.BaseError {
...
class WalletAccountAlreadyVerifiedError extends getNetworkProviderBuilderRegistry.BaseError {
    constructor(address){
        super({
            cause: null,
...
class WalletAccountNotSelectedError extends getNetworkProviderBuilderRegistry.BaseError {
    constructor(params){
        super({
            cause: null,
...
class WalletAlreadyLinkedToAnotherUserError extends getNetworkProviderBuilderRegistry.BaseError {
    constructor({ cause }){
        super({
            cause,
...
const signInWithExternalJwt = async ({ externalJwt, sessionPublicKey } = {}, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
...
const getPasskeys = async (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
...
const serverRegisterPasskey = async ({ registration }, client)=>{
    ...
    const response = await apiClient.registerPasskey({
        environmentId: core.environmentId,
        passkeyRegisterRequest: getNetworkProviderBuilderRegistry._extends({}, registration, {
            response: getNetworkProviderBuilderRegistry._extends({}, registration.response, {
...
const registerPasskey = async (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
...
const serverSigninPasskey = async ({ authentication, createMfaToken }, client)=>{
    ...
    const response = await apiClient.signinWithPasskey({
        environmentId: core.environmentId,
        passkeyAuthRequest: getNetworkProviderBuilderRegistry._extends({}, authentication, {
            createMfaToken,
            response: getNetworkProviderBuilderRegistry._extends({}, authentication.response, {
...
const signInWithPasskey = async (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    if (!core.passkey.isSupported()) {
        throw new NoWebAuthNSupportError();
    }
    const options = await getPasskeyAuthenticationSignInOptions(client);
    const formattedOptions = getNetworkProviderBuilderRegistry._extends({}, options);
...
/** Completes the social redirect sign in flow. */ const completeSocialRedirectSignIn = async ({ url }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
    await core.initTrack.waitForAll();
...
/** Detects if the URL is a redirect from an OAuth provider. */ const detectOAuthRedirect = async ({ url }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const dynamicOauthState = url.searchParams.get('dynamicOauthState');
    const dynamicOauthCode = url.searchParams.get('dynamicOauthCode');
...
/** Helper function to add OAuth URL parameters to a given base URL. */ const addOAuthUrlParams = (provider, baseUrl)=>{
    getNetworkProviderBuilderRegistry.assertDefined(provider.clientId, 'Client ID not found');
    getNetworkProviderBuilderRegistry.assertDefined(provider.provider, 'Provider type not found');
    getNetworkProviderBuilderRegistry.assertDefined(provider.redirectUrl, 'Redirect URL not found');
...
/** Helper function to build the OAuth base URL for a given provider. */ const getOAuthBaseUrl = (provider)=>{
    ...
    if (providerType === sdkApiCore.ProviderEnum.Telegram) {
        getNetworkProviderBuilderRegistry.assertDefined(provider.authorizationUrl, 'Telegram authorization URL not found');
        return new URL(provider.authorizationUrl);
    }
    getNetworkProviderBuilderRegistry.assertDefined(provider.baseAuthUrl, 'Base auth URL not found');
    if (providerType === sdkApiCore.ProviderEnum.Shopify) {
        getNetworkProviderBuilderRegistry.assertDefined(provider.shopifyStore, 'Shopify store value not found in provider');
...
/** Helper function to build the OAuth URL for a given provider. */ const buildOAuthUrl = async (/** The core instance. */ core, /** The provider to build the OAuth URL for. */ provider)=>{
    ...
    getNetworkProviderBuilderRegistry.assertDefined(projectSettings, 'Project settings not found');
    getNetworkProviderBuilderRegistry.assertDefined(projectSettings.providers, 'Project providers not found');
    const socialProvider = projectSettings.providers.find((p)=>p.provider === provider);
    getNetworkProviderBuilderRegistry.assertDefined(socialProvider, `Social provider ${provider} not supported`);
    // Build the OAuth URL
    ...
    const state = getNetworkProviderBuilderRegistry.randomString(32);
    const codeVerifier = getNetworkProviderBuilderRegistry.randomString(43);
...
/** Redirects the user to the OAuth provider's authorization page */ const signInWithSocialRedirect = async ({ provider, redirectUrl, captchaToken }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
    await core.initTrack.waitForAll();
...
const getMultichainBalances = async ({ balanceRequest }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
...
const updateUser = async ({ userFields }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({
...
const acknowledgeRecoveryCodes = async (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    return updateUser({
        userFields: {
...
const authenticatePasskeyMFA = async ({ createMfaToken } = {}, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    try {
        ...
        const allowCredentials = (_options_allowCredentials = options.allowCredentials) == null ? void 0 : _options_allowCredentials.map((credential)=>getNetworkProviderBuilderRegistry._extends({}, credential, {
                type: 'public-key'
            }));
 ...
 */ const authMfaRecoveryCode = async ({ code }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
    try {
 ...
 */ const authTotpMfaDevice = async ({ deviceId, code, createMfaTokenOptions }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
    try {
...
const consumeMfaToken = (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const mfaToken = core.state.get().mfaToken;
    getNetworkProviderBuilderRegistry.assertDefined(mfaToken, 'No MFA token found');
    core.state.set({
        mfaToken: null
    });
    return mfaToken;
 ...
 */ const createNewMfaRecoveryCodes = async (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
 ...
 */ const deleteMfaDevice = async ({ deviceId, mfaAuthToken }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
    getNetworkProviderBuilderRegistry.assertDefined(deviceId, 'deviceId is required');
    getNetworkProviderBuilderRegistry.assertDefined(mfaAuthToken, 'mfaAuthToken is required');
...
const getMfaDevices = async (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
...
const getMfaMethods = async (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
 ...
 */ const getMfaRecoveryCodes = async (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
...
const isPendingRecoveryCodesAcknowledgment = (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const user = client.user;
    getNetworkProviderBuilderRegistry.assertDefined(user, 'User not logged in');
    return user.mfaBackupCodeAcknowledgement !== sdkApiCore.MfaBackupCodeAcknowledgement.Complete;
};

const isUserMissingMfaAuth = (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    var _user_scope;
    const user = client.user;
    getNetworkProviderBuilderRegistry.assertDefined(user, 'User not logged in');
...
const registerTotpMfaDevice = async (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
...
const setDefaultMfaDevice = async ({ deviceId }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
    getNetworkProviderBuilderRegistry.assertDefined(deviceId, 'deviceId is required');
...
const sendEmailOTP = async ({ email }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
...
const sendSmsOTP = async ({ isoCountryCode, phoneNumber }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
...
const verifyOTP = async ({ otpVerification, verificationToken }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
...
const assertWalletAccountSigningAvailability = async ({ walletAccount }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const walletProvider = getNetworkProviderBuilderRegistry.getWalletProviderFromWalletAccount({
        walletAccount
    }, client);
 ...
 */ const connectWithWalletProvider = async ({ walletProvider }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
 ...
 */ const getWalletProviders = (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const walletProviderRegistry = getNetworkProviderBuilderRegistry.getWalletProviderRegistry(client);
    return walletProviderRegistry.listProviders();
};

const mapApiChainNameToSdkChain = {
    cosmos: 'COSMOS',
    eclipse: 'ECLIPSE',
    evm: 'EVM',
    solana: 'SOL',
 ...
 */ const getSdkChainFromApiChainName = (chainName)=>{
    const chain = mapApiChainNameToSdkChain[chainName];
    getNetworkProviderBuilderRegistry.assertDefined(chain, `chain not found for ${chainName}`);
    return chain;
};

const getNetworkProviderConfigurations = (client)=>{
    const { state } = getNetworkProviderBuilderRegistry.getCore(client);
    const { projectSettings } = state.get();
    getNetworkProviderBuilderRegistry.assertDefined(projectSettings, 'projectSettings not found');
    ...
    const networkConfigurations = networks.map((network)=>{
        ...
        if (!(network == null ? void 0 : (_network_networks = network.networks) == null ? void 0 : _network_networks.length)) return [];
 ...
 */ const getNetworkProviders = (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const networkProviderBuilderRegistry = getNetworkProviderBuilderRegistry.getNetworkProviderBuilderRegistry(client);
    const registeredNetworkProviderBuilders = Array.from(networkProviderBuilderRegistry.get().values());
    const networkProviderConfigurations = getNetworkProviderConfigurations(client);
    const networkProviders = registeredNetworkProviderBuilders.map(({ builder, chain })=>{
        const networkProviderConfigurationsForChain = networkProviderConfigurations.filter((networkProviderConfiguration)=>networkProviderConfiguration.chain === chain);
        return networkProviderConfigurationsForChain.map(builder);
    });
 ...
 */ const getPrimaryWalletAccount = (client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const walletAccounts = getWalletAccounts(client);
 ...
 */ const selectPrimaryWalletAccount = async ({ walletAccount }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    ...
    if (walletAccount.verifiedCredentialId) {
        ...
        setUnverifiedWalletAccount({
            unverifiedWalletAccountToUpdate: getNetworkProviderBuilderRegistry._extends({}, walletAccount, {
 ...
 */ const removeWalletAccount = async ({ walletAccount }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const core = getNetworkProviderBuilderRegistry.getCore(client);
    const apiClient = getNetworkProviderBuilderRegistry.createApiClient({}, client);
    if (!walletAccount.verifiedCredentialId) {
 ...
 */ const signMessage = async ({ walletAccount, message }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    const walletProvider = getNetworkProviderBuilderRegistry.getWalletProviderFromWalletAccount({
        walletAccount
    }, client);
 ...
 */ const verifyWalletAccount = async ({ walletAccount }, client = getNetworkProviderBuilderRegistry.getDefaultClient())=>{
    if (walletAccount.verifiedCredentialId) {
    ...
    getNetworkProviderBuilderRegistry.assertDefined(verifiedWalletAccount, 'Verified wallet account not found');
...
exports.BaseError = getNetworkProviderBuilderRegistry.BaseError;
exports.InvalidExternalAuthError = getNetworkProviderBuilderRegistry.InvalidExternalAuthError;
exports.MfaInvalidOtpError = getNetworkProviderBuilderRegistry.MfaInvalidOtpError;
exports.MfaRateLimitedError = getNetworkProviderBuilderRegistry.MfaRateLimitedError;
exports.SandboxMaximumThresholdReachedError = getNetworkProviderBuilderRegistry.SandboxMaximumThresholdReachedError;
exports.hasExtension = getNetworkProviderBuilderRegistry.hasExtension;
exports.offEvent = getNetworkProviderBuilderRegistry.offEvent;
exports.onEvent = getNetworkProviderBuilderRegistry.onEvent;
exports.onceEvent = getNetworkProviderBuilderRegistry.onceEvent;
