 ...
 */
export declare const connectWithWalletProvider: ({ walletProvider }: ConnectWithWalletProviderParams, client?: import("../../../exports").DynamicClient) => Promise<WalletAccount>;
export {};
