...
const Textarea = (_a) => {
    ...
    return (jsxRuntime.jsxs("div", { className: classNames.classNames('textarea__container', {
            ...
            'textarea__container--regular': variant === 'regular',
                ...
                }) })), jsxRuntime.jsx("label", { htmlFor: id, className: classNames.classNames('textarea__label'), children: label }), optional && jsxRuntime.jsx("span", { className: 'textarea__trailing', children: "Optional" }), Boolean(message) && (jsxRuntime.jsx(Typography.Typography, { variant: 'body_mini', className: classNames.classNames('textarea__message', {
