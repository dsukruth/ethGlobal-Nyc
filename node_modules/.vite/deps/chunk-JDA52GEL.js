...
var chainsMap = Object.values(chains_exports).reduce((acc, chain) => Object.assign(Object.assign({}, acc), { [chain.id]: chain }), {});
...
var createWalletClientWithUiConfirmation = ({ address, account, chain, transport, walletConnector, walletUiUtils }) => {
  let client = null;
  const provider = createPublicClient({
    chain,
    transport
...
*/
//# sourceMappingURL=chunk-JDA52GEL.js.map
