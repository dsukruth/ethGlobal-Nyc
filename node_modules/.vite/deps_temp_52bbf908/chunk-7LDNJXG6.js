...
function __createBinding(o4, m3, k4, k22) {
...
function __read(o4, n3) {
  ...
  if (!m3) return o4;
  var i3 = m3.call(o4), r3, ar2 = [], e;
  try {
    while ((n3 === void 0 || n3-- > 0) && !(r3 = i3.next()).done) ar2.push(r3.value);
  } catch (error) {
    e = { error };
  } finally {
    try {
...
function __asyncGenerator(thisArg, _arguments, generator) {
  ...
  function verb(n3) {
    if (g4[n3]) i3[n3] = function(v4) {
      return new Promise(function(a2, b3) {
        q.push([n3, v4, a2, b3]) > 1 || resume(n3, v4);
      });
    };
  }
...
function __asyncDelegator(o4) {
  ...
  function verb(n3, f4) {
    i3[n3] = o4[n3] ? function(v4) {
      return (p3 = !p3) ? { value: __await(o4[n3](v4)), done: n3 === "return" } : f4 ? f4(v4) : v4;
    } : f4;
  }
}
...
var m = class {
  ...
  downloadLogsBlobInBrowser(e) {
    const t = URL.createObjectURL(this.logsToBlob(e)), o4 = document.createElement("a");
...
var f = (r3, e, t) => e in r3 ? x(r3, e, { enumerable: true, configurable: true, writable: true, value: t }) : r3[e] = t;
var i = (r3, e) => {
  for (var t in e || (e = {})) T.call(e, t) && f(r3, t, e[t]);
  if (p) for (var t of p(e)) z.call(e, t) && f(r3, t, e[t]);
  return r3;
};
var g = (r3, e) => S(r3, _(e));
function k(r3) {
...
function y(r3, e = n) {
  let t = "";
  return typeof r3.bindings > "u" ? t = v(r3, e) : t = r3.bindings().context || "", t;
}
function w(r3, e, t = n) {
  const o4 = y(r3, t);
  return o4.trim() ? `${o4}/${e}` : e;
}
function E(r3, e, t = n) {
  const o4 = w(r3, e, t), a2 = r3.child({ context: o4 });
  return b(a2, o4, t);
}
function C(r3) {
  var e, t;
  const o4 = new m((e = r3.opts) == null ? void 0 : e.level, r3.maxSizeInBytes);
...
function I(r3) {
  var e;
  const t = new B((e = r3.opts) == null ? void 0 : e.level, r3.maxSizeInBytes);
...
var l2 = (r3, t, e) => t in r3 ? P(r3, t, { enumerable: true, configurable: true, writable: true, value: e }) : r3[t] = e;
var p2 = (r3, t) => {
  for (var e in t || (t = {})) L2.call(t, e) && l2(r3, e, t[e]);
  if (c3) for (var e of c3(t)) O2.call(t, e) && l2(r3, e, t[e]);
  return r3;
};
...
var f2 = class {
  ...
  async send(t) {
    ...
    try {
      const e = safeJsonStringify(t), s3 = await (await (0, import_cross_fetch.default)(this.url, v2(p2({}, d2), { body: e }))).json();
  ...
  async register(t = this.url) {
    ...
    if (this.registering) {
      ...
      return (this.events.listenerCount("register_error") >= e || this.events.listenerCount("open") >= e) && this.events.setMaxListeners(e + 1), new Promise((s3, i3) => {
    ...
    try {
      if (!this.disableProviderPing) {
        ...
        await (0, import_cross_fetch.default)(t, v2(p2({}, d2), { body: e }));
      }
      this.onOpen();
    } catch (e) {
      const s3 = this.parseError(e);
  ...
  onError(t, e) {
    const s3 = this.parseError(e), i3 = s3.message || s3.toString(), n3 = formatJsonRpcError(t, i3);
...
function Bn(t) {
  const e = (r3) => t().update(de(r3)).digest(), n3 = t();
...
function Cn(t, e, n3, r3) {
  if (typeof t.setBigUint64 == "function") return t.setBigUint64(e, n3, r3);
  const o4 = BigInt(32), s3 = BigInt(4294967295), a2 = Number(n3 >> o4 & s3), u = Number(n3 & s3), i3 = r3 ? 4 : 0, D2 = r3 ? 0 : 4;
  t.setUint32(e + i3, a2, r3), t.setUint32(e + D2, u, r3);
}
var An = class extends xn {
  constructor(e, n3, r3, o4) {
    super(), this.blockLen = e, this.outputLen = n3, this.padOffset = r3, this.isLE = o4, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e), this.view = _t(this.buffer);
  }
  update(e) {
    De(this);
    ...
    for (let a2 = 0; a2 < s3; ) {
      ...
      r3.set(e.subarray(a2, a2 + u), this.pos), this.pos += u, a2 += u, this.pos === o4 && (this.process(n3, 0), this.pos = 0);
    }
    return this.length += e.length, this.roundClean(), this;
  }
  digestInto(e) {
    De(this), gn(e, this), this.finished = true;
    const { buffer: n3, view: r3, blockLen: o4, isLE: s3 } = this;
    let { pos: a2 } = this;
    n3[a2++] = 128, this.buffer.subarray(a2).fill(0), this.padOffset > o4 - a2 && (this.process(r3, 0), a2 = 0);
    for (let l6 = a2; l6 < o4; l6++) n3[l6] = 0;
    Cn(r3, o4 - 8, BigInt(this.length * 8), s3), this.process(r3, 0);
    const u = _t(e), i3 = this.outputLen;
  ...
  digest() {
    ...
    this.digestInto(e);
    const r3 = e.slice(0, n3);
    return this.destroy(), r3;
  }
  _cloneInto(e) {
    e || (e = new this.constructor()), e.set(...this.get());
    const { blockLen: n3, buffer: r3, length: o4, finished: s3, destroyed: a2, pos: u } = this;
    return e.length = o4, e.pos = u, e.finished = s3, e.destroyed = a2, o4 % n3 && e.buffer.set(r3), e;
  }
};
...
var Fn = (t, e, n3) => t >>> n3 - 32 | e << 64 - n3;
var Nn = (t, e) => e;
var Ln = (t, e) => t;
var On = (t, e, n3) => t << n3 | e >>> 32 - n3;
var Hn = (t, e, n3) => e << n3 | t >>> 32 - n3;
var zn = (t, e, n3) => e << n3 - 32 | t >>> 64 - n3;
var Mn = (t, e, n3) => t << n3 - 32 | e >>> 64 - n3;
function qn(t, e, n3, r3) {
  const o4 = (e >>> 0) + (r3 >>> 0);
  return { h: t + n3 + (o4 / 2 ** 32 | 0) | 0, l: o4 | 0 };
}
var $n = (t, e, n3) => (t >>> 0) + (e >>> 0) + (n3 >>> 0);
var kn = (t, e, n3, r3) => e + n3 + r3 + (t / 2 ** 32 | 0) | 0;
var Rn = (t, e, n3, r3) => (t >>> 0) + (e >>> 0) + (n3 >>> 0) + (r3 >>> 0);
var jn = (t, e, n3, r3, o4) => e + n3 + r3 + o4 + (t / 2 ** 32 | 0) | 0;
var Zn = (t, e, n3, r3, o4) => (t >>> 0) + (e >>> 0) + (n3 >>> 0) + (r3 >>> 0) + (o4 >>> 0);
var Gn = (t, e, n3, r3, o4, s3) => e + n3 + r3 + o4 + s3 + (t / 2 ** 32 | 0) | 0;
...
var Jn = class extends An {
  ...
  get() {
    const { Ah: e, Al: n3, Bh: r3, Bl: o4, Ch: s3, Cl: a2, Dh: u, Dl: i3, Eh: D2, El: c5, Fh: l6, Fl: p3, Gh: w4, Gl: h4, Hh: g4, Hl: S2 } = this;
    return [e, n3, r3, o4, s3, a2, u, i3, D2, c5, l6, p3, w4, h4, g4, S2];
  }
  set(e, n3, r3, o4, s3, a2, u, i3, D2, c5, l6, p3, w4, h4, g4, S2) {
    this.Ah = e | 0, this.Al = n3 | 0, this.Bh = r3 | 0, this.Bl = o4 | 0, this.Ch = s3 | 0, this.Cl = a2 | 0, this.Dh = u | 0, this.Dl = i3 | 0, this.Eh = D2 | 0, this.El = c5 | 0, this.Fh = l6 | 0, this.Fl = p3 | 0, this.Gh = w4 | 0, this.Gl = h4 | 0, this.Hh = g4 | 0, this.Hl = S2 | 0;
  }
  process(e, n3) {
    for (let d4 = 0; d4 < 16; d4++, n3 += 4) P2[d4] = e.getUint32(n3), Q[d4] = e.getUint32(n3 += 4);
    for (let d4 = 16; d4 < 80; d4++) {
      const m3 = P2[d4 - 15] | 0, F = Q[d4 - 15] | 0, q = x2.rotrSH(m3, F, 1) ^ x2.rotrSH(m3, F, 8) ^ x2.shrSH(m3, F, 7), z3 = x2.rotrSL(m3, F, 1) ^ x2.rotrSL(m3, F, 8) ^ x2.shrSL(m3, F, 7), I2 = P2[d4 - 2] | 0, O4 = Q[d4 - 2] | 0, ot = x2.rotrSH(I2, O4, 19) ^ x2.rotrBH(I2, O4, 61) ^ x2.shrSH(I2, O4, 6), tt = x2.rotrSL(I2, O4, 19) ^ x2.rotrBL(I2, O4, 61) ^ x2.shrSL(I2, O4, 6), st = x2.add4L(z3, tt, Q[d4 - 7], Q[d4 - 16]), at = x2.add4H(st, q, ot, P2[d4 - 7], P2[d4 - 16]);
      P2[d4] = at | 0, Q[d4] = st | 0;
    }
    let { Ah: r3, Al: o4, Bh: s3, Bl: a2, Ch: u, Cl: i3, Dh: D2, Dl: c5, Eh: l6, El: p3, Fh: w4, Fl: h4, Gh: g4, Gl: S2, Hh: v4, Hl: L3 } = this;
    for (let d4 = 0; d4 < 80; d4++) {
      const m3 = x2.rotrSH(l6, p3, 14) ^ x2.rotrSH(l6, p3, 18) ^ x2.rotrBH(l6, p3, 41), F = x2.rotrSL(l6, p3, 14) ^ x2.rotrSL(l6, p3, 18) ^ x2.rotrBL(l6, p3, 41), q = l6 & w4 ^ ~l6 & g4, z3 = p3 & h4 ^ ~p3 & S2, I2 = x2.add5L(L3, F, z3, Yn[d4], Q[d4]), O4 = x2.add5H(I2, v4, m3, q, Vn[d4], P2[d4]), ot = I2 | 0, tt = x2.rotrSH(r3, o4, 28) ^ x2.rotrBH(r3, o4, 34) ^ x2.rotrBH(r3, o4, 39), st = x2.rotrSL(r3, o4, 28) ^ x2.rotrBL(r3, o4, 34) ^ x2.rotrBL(r3, o4, 39), at = r3 & s3 ^ r3 & u ^ s3 & u, Ct = o4 & a2 ^ o4 & i3 ^ a2 & i3;
      v4 = g4 | 0, L3 = S2 | 0, g4 = w4 | 0, S2 = h4 | 0, w4 = l6 | 0, h4 = p3 | 0, { h: l6, l: p3 } = x2.add(D2 | 0, c5 | 0, O4 | 0, ot | 0), D2 = u | 0, c5 = i3 | 0, u = s3 | 0, i3 = a2 | 0, s3 = r3 | 0, a2 = o4 | 0;
      const At = x2.add3L(ot, st, Ct);
      r3 = x2.add3H(At, O4, tt, at), o4 = At | 0;
    }
    ({ h: r3, l: o4 } = x2.add(this.Ah | 0, this.Al | 0, r3 | 0, o4 | 0)), { h: s3, l: a2 } = x2.add(this.Bh | 0, this.Bl | 0, s3 | 0, a2 | 0), { h: u, l: i3 } = x2.add(this.Ch | 0, this.Cl | 0, u | 0, i3 | 0), { h: D2, l: c5 } = x2.add(this.Dh | 0, this.Dl | 0, D2 | 0, c5 | 0), { h: l6, l: p3 } = x2.add(this.Eh | 0, this.El | 0, l6 | 0, p3 | 0), { h: w4, l: h4 } = x2.add(this.Fh | 0, this.Fl | 0, w4 | 0, h4 | 0), { h: g4, l: S2 } = x2.add(this.Gh | 0, this.Gl | 0, g4 | 0, S2 | 0), { h: v4, l: L3 } = x2.add(this.Hh | 0, this.Hl | 0, v4 | 0, L3 | 0), this.set(r3, o4, s3, a2, u, i3, D2, c5, l6, p3, w4, h4, g4, S2, v4, L3);
  }
  roundClean() {
    P2.fill(0), Q.fill(0);
  }
...
function Ft(t) {
  Ut(t);
  let e = "";
  for (let n3 = 0; n3 < t.length; n3++) e += Xn[t[n3]];
  return e;
}
function pe(t) {
...
function Ee(t) {
  ...
  for (let o4 = 0, s3 = 0; o4 < n3; o4++, s3 += 2) {
...
function W(t, e, n3) {
  ...
  else if (It(e)) r3 = Uint8Array.from(e);
...
function ye(...t) {
  ...
  for (let r3 = 0, o4 = 0; r3 < t.length; r3++) {
    const s3 = t[r3];
    n3.set(s3, o4), o4 += s3.length;
  }
  return n3;
}
var Lt = (t) => typeof t == "bigint" && vt <= t;
function Qn(t, e, n3) {
  return Lt(t) && Lt(e) && Lt(n3) && e <= t && t < n3;
}
function ft(t, e, n3, r3) {
  if (!Qn(e, n3, r3)) throw new Error("expected valid " + t + ": " + n3 + " <= n < " + r3 + ", got " + e);
}
function tr(t) {
  let e;
...
function Ot(t, e, n3 = {}) {
  ...
  for (const [o4, s3] of Object.entries(e)) r3(o4, s3, false);
  for (const [o4, s3] of Object.entries(n3)) r3(o4, s3, true);
  return t;
}
function xe(t) {
...
function or(t, e, n3) {
  ...
  if (n3 === N) return M;
  let r3 = N;
  for (; e > M; ) e & N && (r3 = r3 * t % n3), t = t * t % n3, e >>= N;
  return r3;
}
function J(t, e, n3) {
  let r3 = t;
...
function Ae(t, e) {
  ...
  let n3 = H(t, e), r3 = e, o4 = M, s3 = N;
  for (; n3 !== M; ) {
    const u = r3 / n3, i3 = r3 % n3, D2 = o4 - s3 * u;
    r3 = n3, n3 = i3, o4 = s3, s3 = D2;
  }
...
function sr(t) {
  ...
  for (o4 = nt; o4 < t && or(o4, e, t) !== t - N; o4++) if (o4 > 1e3) throw new Error("Cannot find square root: likely non-prime P");
  if (r3 === 1) {
    const a2 = (t + N) / Ht;
  ...
  return function(u, i3) {
    if (u.pow(i3, e) === u.neg(u.ONE)) throw new Error("Cannot find square root");
    let D2 = r3, c5 = u.pow(u.mul(u.ONE, o4), n3), l6 = u.pow(i3, s3), p3 = u.pow(i3, n3);
    for (; !u.eql(p3, u.ONE); ) {
...
function ir(t) {
  ...
  if (t % Ce === Be) {
    const e = (t - Be) / Ce;
    return function(r3, o4) {
      const s3 = r3.mul(o4, nt), a2 = r3.pow(s3, e), u = r3.mul(o4, a2), i3 = r3.mul(r3.mul(u, nt), a2), D2 = r3.mul(u, r3.sub(i3, r3.ONE));
...
function ar(t) {
  const e = { ORDER: "bigint", MASK: "bigint", BYTES: "isSafeInteger", BITS: "isSafeInteger" }, n3 = cr.reduce((r3, o4) => (r3[o4] = "function", r3), e);
  return Ot(t, n3);
}
function fr(t, e, n3) {
...
function Dr(t, e) {
  const n3 = new Array(e.length), r3 = e.reduce((s3, a2, u) => t.is0(a2) ? s3 : (n3[u] = s3, t.mul(s3, a2)), t.ONE), o4 = t.inv(r3);
  return e.reduceRight((s3, a2, u) => t.is0(a2) ? s3 : (n3[u] = t.mul(s3, n3[u]), t.mul(s3, a2)), o4), n3;
}
function me(t, e) {
  const n3 = e !== void 0 ? e : t.toString(2).length, r3 = Math.ceil(n3 / 8);
  return { nBitLength: n3, nByteLength: r3 };
}
function _e(t, e, n3 = false, r3 = {}) {
  if (t <= M) throw new Error("invalid field: expected ORDER > 0, got " + t);
  const { nBitLength: o4, nByteLength: s3 } = me(t, e);
  if (s3 > 2048) throw new Error("invalid field: expected ORDER of <= 2048 bytes");
  let a2;
  const u = Object.freeze({ ORDER: t, isLE: n3, BITS: o4, BYTES: s3, MASK: er(o4), ZERO: M, ONE: N, create: (i3) => H(i3, t), isValid: (i3) => {
    if (typeof i3 != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof i3);
    return M <= i3 && i3 < t;
  }, is0: (i3) => i3 === M, isOdd: (i3) => (i3 & N) === N, neg: (i3) => H(-i3, t), eql: (i3, D2) => i3 === D2, sqr: (i3) => H(i3 * i3, t), add: (i3, D2) => H(i3 + D2, t), sub: (i3, D2) => H(i3 - D2, t), mul: (i3, D2) => H(i3 * D2, t), pow: (i3, D2) => fr(u, i3, D2), div: (i3, D2) => H(i3 * Ae(D2, t), t), sqrN: (i3) => i3 * i3, addN: (i3, D2) => i3 + D2, subN: (i3, D2) => i3 - D2, mulN: (i3, D2) => i3 * D2, inv: (i3) => Ae(i3, t), sqrt: r3.sqrt || ((i3) => (a2 || (a2 = ir(t)), a2(u, i3))), invertBatch: (i3) => Dr(u, i3), cmov: (i3, D2, c5) => c5 ? D2 : i3, toBytes: (i3) => n3 ? Nt(i3, s3) : ge(i3, s3), fromBytes: (i3) => {
...
function Mt(t, e) {
  ve(t, e);
  const n3 = Math.ceil(e / t) + 1, r3 = 2 ** (t - 1);
  return { windows: n3, windowSize: r3 };
}
function dr(t, e) {
  if (!Array.isArray(t)) throw new Error("array expected");
  t.forEach((n3, r3) => {
    if (!(n3 instanceof e)) throw new Error("invalid point at index " + r3);
  });
}
function hr(t, e) {
  if (!Array.isArray(t)) throw new Error("array of scalars expected");
  t.forEach((n3, r3) => {
    if (!e.isValid(n3)) throw new Error("invalid scalar at index " + r3);
  });
}
...
function lr(t, e) {
  return { constTimeNegate: zt, hasPrecomputes(n3) {
    ...
    const { windows: o4, windowSize: s3 } = Mt(r3, e), a2 = [];
    let u = n3, i3 = u;
    ...
    const { windows: s3, windowSize: a2 } = Mt(n3, e);
    let u = t.ZERO, i3 = t.BASE;
    const D2 = BigInt(2 ** n3 - 1), c5 = 2 ** n3, l6 = BigInt(n3);
    for (let p3 = 0; p3 < s3; p3++) {
      const w4 = p3 * a2;
      let h4 = Number(o4 & D2);
      o4 >>= l6, h4 > a2 && (h4 -= c5, o4 += gt);
      const g4 = w4, S2 = w4 + Math.abs(h4) - 1, v4 = p3 % 2 !== 0, L3 = h4 < 0;
      h4 === 0 ? i3 = i3.add(zt(v4, r3[g4])) : u = u.add(zt(L3, r3[S2]));
    }
    return { p: u, f: i3 };
  }, wNAFUnsafe(n3, r3, o4, s3 = t.ZERO) {
    const { windows: a2, windowSize: u } = Mt(n3, e), i3 = BigInt(2 ** n3 - 1), D2 = 2 ** n3, c5 = BigInt(n3);
    for (let l6 = 0; l6 < a2; l6++) {
      const p3 = l6 * u;
      if (o4 === Se) break;
      let w4 = Number(o4 & i3);
      if (o4 >>= c5, w4 > u && (w4 -= D2, o4 += gt), w4 === 0) continue;
    ...
    let s3 = qt.get(r3);
    return s3 || (s3 = this.precomputeWindow(r3, n3), n3 !== 1 && qt.set(r3, o4(s3))), s3;
  }, wNAFCached(n3, r3, o4) {
    const s3 = $t(n3);
    return this.wNAF(s3, this.getPrecomputes(s3, n3, o4), r3);
  }, wNAFCachedUnsafe(n3, r3, o4, s3) {
    const a2 = $t(n3);
    return a2 === 1 ? this.unsafeLadder(n3, r3, s3) : this.wNAFUnsafe(a2, this.getPrecomputes(a2, n3, o4), r3, s3);
  }, setWindowSize(n3, r3) {
    ve(r3, e), Ie.set(n3, r3), qt.delete(n3);
  } };
}
function br(t, e, n3, r3) {
  if (dr(n3, t), hr(r3, e), n3.length !== r3.length) throw new Error("arrays of points and scalars must have equal length");
  const o4 = t.ZERO, s3 = tr(BigInt(n3.length)), a2 = s3 > 12 ? s3 - 3 : s3 > 4 ? s3 - 2 : s3 ? 2 : 1, u = (1 << a2) - 1, i3 = new Array(u + 1).fill(o4), D2 = Math.floor((e.BITS - 1) / a2) * a2;
  let c5 = o4;
  for (let l6 = D2; l6 >= 0; l6 -= a2) {
    i3.fill(o4);
    for (let w4 = 0; w4 < r3.length; w4++) {
      const h4 = r3[w4], g4 = Number(h4 >> BigInt(l6) & BigInt(u));
      i3[g4] = i3[g4].add(n3[w4]);
    }
    let p3 = o4;
    for (let w4 = i3.length - 1, h4 = o4; w4 > 0; w4--) h4 = h4.add(i3[w4]), p3 = p3.add(h4);
...
function yr(t) {
  const e = gr(t), { Fp: n3, n: r3, prehash: o4, hash: s3, randomBytes: a2, nByteLength: u, h: i3 } = e, D2 = yt << BigInt(u * 8) - j2, c5 = n3.create, l6 = _e(e.n, e.nBitLength), p3 = e.uvRatio || ((y3, f4) => {
    try {
      return { isValid: true, value: n3.sqrt(y3 * n3.inv(f4)) };
    } catch {
      return { isValid: false, value: G };
    }
  }), w4 = e.adjustScalarBytes || ((y3) => y3), h4 = e.domain || ((y3, f4, b3) => {
  ...
  class d4 {
    ...
    static fromAffine(f4) {
      ...
      const { x: b3, y: E4 } = f4 || {};
      return g4("x", b3), g4("y", E4), new d4(b3, E4, j2, c5(b3 * E4));
    }
    static normalizeZ(f4) {
      const b3 = n3.invertBatch(f4.map((E4) => E4.ez));
    ...
    double() {
      const { a: f4 } = e, { ex: b3, ey: E4, ez: B2 } = this, C3 = c5(b3 * b3), A2 = c5(E4 * E4), U2 = c5(yt * c5(B2 * B2)), _3 = c5(f4 * C3), T3 = b3 + E4, $ = c5(c5(T3 * T3) - C3 - A2), R = _3 + A2, V = R - U2, Y = _3 - A2, Z = c5($ * V), X = c5(R * Y), et = c5($ * Y), pt = c5(V * R);
      return new d4(Z, X, pt, et);
    }
    add(f4) {
      S2(f4);
      const { a: b3, d: E4 } = e, { ex: B2, ey: C3, ez: A2, et: U2 } = this, { ex: _3, ey: T3, ez: $, et: R } = f4;
      if (b3 === BigInt(-1)) {
    ...
    multiplyUnsafe(f4, b3 = d4.ZERO) {
      const E4 = f4;
      return ft("scalar", E4, G, r3), E4 === G ? F : this.is0() || E4 === j2 ? this : q.wNAFCachedUnsafe(this, E4, d4.normalizeZ, b3);
    }
    isSmallOrder() {
    ...
    static fromHex(f4, b3 = false) {
      const { d: E4, a: B2 } = e, C3 = n3.BYTES;
      f4 = W("pointHex", f4, C3), Tt("zip215", b3);
      const A2 = f4.slice(), U2 = f4[C3 - 1];
      A2[C3 - 1] = U2 & -129;
      const _3 = Et(A2), T3 = b3 ? D2 : n3.ORDER;
      ft("pointHex.y", _3, G, T3);
      const $ = c5(_3 * _3), R = c5($ - j2), V = c5(E4 * $ - B2);
    ...
    toRawBytes() {
      const { x: f4, y: b3 } = this.toAffine(), E4 = Nt(b3, n3.BYTES);
  ...
  d4.BASE = new d4(e.Gx, e.Gy, j2, c5(e.Gx * e.Gy)), d4.ZERO = new d4(G, j2, j2, G);
  ...
  function Ct(y3, f4, b3, E4 = at) {
    const { context: B2, zip215: C3 } = E4, A2 = n3.BYTES;
    y3 = W("signature", y3, 2 * A2), f4 = W("message", f4), b3 = W("publicKey", b3, A2), C3 !== void 0 && Tt("zip215", C3), o4 && (f4 = o4(f4));
  ...
  return m3._setWindowSize(8), { CURVE: e, getPublicKey: ot, sign: st, verify: Ct, ExtendedPoint: d4, utils: { getExtendedPublicKey: O4, randomPrivateKey: () => a2(n3.BYTES), precompute(y3 = 8, f4 = d4.BASE) {
...
var Cr = BigInt(8);
function Ar(t) {
  const e = BigInt(10), n3 = BigInt(20), r3 = BigInt(40), o4 = BigInt(80), s3 = kt, u = t * t % s3 * t % s3, i3 = J(u, Te, s3) * u % s3, D2 = J(i3, xr, s3) * t % s3, c5 = J(D2, Br, s3) * D2 % s3, l6 = J(c5, e, s3) * c5 % s3, p3 = J(l6, n3, s3) * l6 % s3, w4 = J(p3, r3, s3) * p3 % s3, h4 = J(w4, o4, s3) * w4 % s3, g4 = J(h4, o4, s3) * w4 % s3, S2 = J(g4, e, s3) * c5 % s3;
...
function _r(t, e) {
  const n3 = kt, r3 = H(e * e * e, n3), o4 = H(r3 * r3 * e, n3), s3 = Ar(t * o4).pow_p_5_8;
  let a2 = H(t * r3 * s3, n3);
  const u = H(e * a2 * a2, n3), i3 = a2, D2 = H(a2 * Ue, n3), c5 = u === t, l6 = u === H(-t, n3), p3 = u === H(-t * Ue, n3);
  return c5 && (a2 = i3), (l6 || p3) && (a2 = D2), ur(a2, n3) && (a2 = H(-a2, n3)), { isValid: c5 || l6, value: a2 };
}
...
function Oe(t, e) {
  e || (e = t.reduce((o4, s3) => o4 + s3.length, 0));
  const n3 = Le(e);
  let r3 = 0;
...
function Ir(t, e) {
  ...
  for (var o4 = 0; o4 < t.length; o4++) {
    ...
    if (n3[a2] !== 255) throw new TypeError(s3 + " is ambiguous");
    n3[a2] = o4;
  }
...
var Lr = class {
  constructor(e, n3, r3) {
    this.name = e, this.prefix = n3, this.baseEncode = r3;
  }
  encode(e) {
...
var Hr = class {
  ...
  decode(e) {
    const n3 = e[0], r3 = this.decoders[n3];
    if (r3) return r3.decode(e);
...
var zr = class {
  constructor(e, n3, r3, o4) {
    this.name = e, this.prefix = n3, this.baseEncode = r3, this.baseDecode = o4, this.encoder = new Lr(e, n3, r3), this.decoder = new Or(e, n3, o4);
  }
  encode(e) {
...
var Bt = ({ name: t, prefix: e, encode: n3, decode: r3 }) => new zr(t, e, n3, r3);
var ht = ({ prefix: t, name: e, alphabet: n3 }) => {
  const { encode: r3, decode: o4 } = Tr(n3, e);
  return Bt({ prefix: t, name: e, encode: r3, decode: (s3) => He(o4(s3)) });
};
var Mr = (t, e, n3, r3) => {
  const o4 = {};
  for (let c5 = 0; c5 < e.length; ++c5) o4[e[c5]] = c5;
  let s3 = t.length;
  for (; t[s3 - 1] === "="; ) --s3;
  const a2 = new Uint8Array(s3 * n3 / 8 | 0);
  let u = 0, i3 = 0, D2 = 0;
  for (let c5 = 0; c5 < s3; ++c5) {
    const l6 = o4[t[c5]];
    if (l6 === void 0) throw new SyntaxError(`Non-${r3} character`);
    i3 = i3 << n3 | l6, u += n3, u >= 8 && (u -= 8, a2[D2++] = 255 & i3 >> u);
  }
  if (u >= n3 || 255 & i3 << 8 - u) throw new SyntaxError("Unexpected end of data");
  return a2;
};
var qr = (t, e, n3) => {
  const r3 = e[e.length - 1] === "=", o4 = (1 << n3) - 1;
  let s3 = "", a2 = 0, u = 0;
  for (let i3 = 0; i3 < t.length; ++i3) for (u = u << 8 | t[i3], a2 += 8; a2 > n3; ) a2 -= n3, s3 += e[o4 & u >> a2];
  if (a2 && (s3 += e[o4 & u << n3 - a2]), r3) for (; s3.length * n3 & 7; ) s3 += "=";
  return s3;
};
var k2 = ({ name: t, prefix: e, bitsPerChar: n3, alphabet: r3 }) => Bt({ prefix: e, name: t, encode(o4) {
  return qr(o4, r3, n3);
}, decode(o4) {
...
function $e(t, e, n3) {
  e = e || [], n3 = n3 || 0;
  for (var r3 = n3; t >= vo; ) e[n3++] = t & 255 | qe, t /= 128;
  for (; t & So; ) e[n3++] = t & 255 | qe, t >>>= 7;
  return e[n3] = t | 0, $e.bytes = n3 - r3 + 1, e;
}
var Io = Pt;
var Uo = 128;
var ke = 127;
function Pt(t, r3) {
  var n3 = 0, r3 = r3 || 0, o4 = 0, s3 = r3, a2, u = t.length;
  do {
    if (s3 >= u) throw Pt.bytes = 0, new RangeError("Could not decode varint");
    a2 = t[s3++], n3 += o4 < 28 ? (a2 & ke) << o4 : (a2 & ke) * Math.pow(2, o4), o4 += 7;
  } while (a2 >= Uo);
  return Pt.bytes = s3 - r3, n3;
}
var To = Math.pow(2, 7);
...
var Qt = (t, e) => {
  const n3 = e.byteLength, r3 = Ze(t), o4 = r3 + Ze(n3), s3 = new Uint8Array(o4 + n3);
  return je(t, s3, 0), je(n3, s3, r3), s3.set(e, o4), new Ro(t, n3, e, s3);
};
var Ro = class {
  constructor(e, n3, r3, o4) {
    this.code = e, this.size = n3, this.digest = r3, this.bytes = o4;
  }
};
var Ge = ({ name: t, code: e, encode: n3 }) => new jo(t, e, n3);
var jo = class {
  constructor(e, n3, r3) {
    this.name = e, this.code = n3, this.encode = r3;
  }
  digest(e) {
...
({ ...Vo, ...Wo });
function We(t, e, n3, r3) {
  return { name: t, prefix: e, encoder: { name: t, prefix: e, encode: n3 }, decoder: { decode: r3 } };
}
...
function Qe(t) {
  const e = rt(Wt, dt), n3 = Kt + ct(Oe([e, t]), dt);
...
function sn(t) {
  const e = t.split(ut), n3 = lt(e[0]), r3 = lt(e[1]), o4 = nn(e[2]), s3 = rt(e.slice(0, 2).join(ut), xt);
  return { header: n3, payload: r3, signature: o4, data: s3 };
}
function Po(t = he(Ne)) {
  const e = Rt.getPublicKey(t);
  return { secretKey: Oe([t, e]), publicKey: e };
}
async function Qo(t, e, n3, r3, o4 = (0, import_time.fromMiliseconds)(Date.now())) {
  const s3 = { alg: jt, typ: Zt }, a2 = Qe(r3.publicKey), u = o4 + n3, i3 = { iss: a2, sub: t, aud: e, iat: o4, exp: u }, D2 = rn({ header: s3, payload: i3 }), c5 = Rt.sign(D2, r3.secretKey.slice(0, 32));
...
var i2 = class _i extends n2 {
  constructor(e) {
    super(e), this.events = new import_events3.EventEmitter(), this.interval = s2, this.interval = e?.interval || s2;
  }
  static async init(e) {
    const t = new _i(e);
...
var x3 = "idb-keyval";
var z2 = (i3 = {}) => {
  const t = i3.base && i3.base.length > 0 ? `${i3.base}:` : "", e = (s3) => t + s3;
  let n3;
  return i3.dbName && i3.storeName && (n3 = createStore(i3.dbName, i3.storeName)), { name: x3, options: i3, async hasItem(s3) {
    return !(typeof await get(e(s3), n3) > "u");
  }, async getItem(s3) {
    return await get(e(s3), n3) ?? null;
  }, setItem(s3, a2) {
    return set(e(s3), a2, n3);
  }, removeItem(s3) {
    return del(e(s3), n3);
  }, getKeys() {
    return keys(n3);
...
var y2 = 1;
var O3 = async (i3, t, e) => {
  const n3 = N2, s3 = await t.getItem(n3);
  if (s3 && s3 >= y2) {
    e(t);
    return;
  }
  ...
  await t.setItem(n3, y2), e(t), j3(i3, m3);
};
var j3 = async (i3, t) => {
...
var f3 = class {
  constructor(e) {
    if (this.url = e, this.events = new import_events5.EventEmitter(), this.registering = false, !isWsUrl(e)) throw new Error(`Provided URL is not compatible with WebSocket connection: ${e}`);
    this.url = e;
  }
  get connected() {
  ...
  register(e = this.url) {
    ...
    if (this.registering) {
      ...
      return (this.events.listenerCount("register_error") >= t || this.events.listenerCount("open") >= t) && this.events.setMaxListeners(t + 1), new Promise((n3, s3) => {
    ...
    return this.url = e, this.registering = true, new Promise((t, n3) => {
      const s3 = (0, esm_exports.isReactNative)() ? void 0 : { rejectUnauthorized: !isLocalhostUrl(e) }, o4 = new b2(e, [], s3);
      w3() ? o4.onerror = (i3) => {
        const a2 = i3;
  ...
  onError(e, t) {
    const n3 = this.parseError(t), s3 = n3.message || n3.toString(), o4 = formatJsonRpcError(e, s3);
    this.events.emit("payload", o4);
  }
  parseError(e, t = this.url) {
    return parseConnectionError(e, d3(t), "WS");
  }
  resetMaxListeners() {
    this.events.getMaxListeners() > h3 && this.events.setMaxListeners(h3);
  }
  emitError(e) {
    const t = this.parseError(new Error(e?.message || `WebSocket connection failed for host: ${d3(this.url)}`));
...
*/
//# sourceMappingURL=chunk-7LDNJXG6.js.map
